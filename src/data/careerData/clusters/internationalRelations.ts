...
export const internationalRelationsCareers: Career[] = [
  {
    ...
    roadmap: [
      ...
      "Prepare for and pass Foreign Service exam",
      "Complete diplomatic training program",
      "Gain experience through overseas postings"
    ]
  },
  {
    ...
    roadmap: [
      ...
      "Develop expertise in specific development areas (health, education, etc.)",
      "Build experience managing international projects",
      "Learn about major development organizations and funding sources"
    ]
  },
  {
    ...
    roadmap: [
      ...
      "Gain international experience through fieldwork",
      "Learn about major global health organizations and initiatives",
      "Build expertise in specific health areas or regions"
    ]
  },
  {
    ...
    roadmap: [
      ...
      "Gain international experience through work or travel",
      "Develop training programs and consulting methodologies"
    ]
  },
  {
    ...
    roadmap: [
      ...
      "Develop expertise in specific regions or industries",
